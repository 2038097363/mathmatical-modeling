...
所有命令均从本目录运行。LaTeX/XeLaTeX 是论文权威构建链。完整稿为
`论文/A题论文.pdf`（56 页，含 4 个核心求解程序附录）。问题四 50000 次正式确认与独立完整域审计均已通过；
...
- `论文/`：LaTeX 主文件、参考文献、生成内容、正式图件、FreeCAD 模型和审阅 PDF。`main.tex` + `content.tex` + `source_appendix.tex` 构成完整论文源码。
- `审计/`：项目、论文、图件和交付门禁报告。
